...
export default class PrototypoText extends React.Component {
	...
	componentDidUpdate(prevProps) {
		if (
			...
			&& this.props[this.props.field] !== prevProps[prevProps.field]
		) {
			this.setText(this.props[this.props.field]);
		}
		if (this.props.indivCurrentGroup !== prevProps.indivCurrentGroup) {
			this.updateIndivGroupDecorator(this.props.indivCurrentGroup);
		}
	}
